...
func (uc *VisionUseCase) UseCaseAnalyzeImageFromURL(ctx context.Context, url, prompt, modelo, qualidadeImagem string) (*entities.ImagemAnalyzeResponse, error) {
...
func (uc *VisionUseCase) UseCasAnalyzeImageFromBase64(ctx context.Context, base64, prompt, modelo, qualidadeImagem string) (*entities.ImagemAnalyzeResponse, error) {
